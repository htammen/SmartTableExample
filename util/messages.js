jQuery.sap.declare("com.tammenit.smarttbl.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.tammenit.smarttbl.util.messages = {};
 ...
 * @public
 */
com.tammenit.smarttbl.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.tammenit.smarttbl.util.messages._parseError(oParameter);
...
com.tammenit.smarttbl.util.messages.getErrorContent = function(oParameter) {
	return com.tammenit.smarttbl.util.messages._parseError(oParameter).sMessage;
};

com.tammenit.smarttbl.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
